...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    function processForm() {
        ...
        //store q4 in a variable called q4
        ...
        if (q1 == "A" && q2 == "C" && q3 == "C" && q4 == "C" && q5 == "A" && q6 == "B" && q7 == "A"){
        ...
        document.getElementById("message").style.backgroundColor = "rgba(82, 135, 77, 0.7)";
        document.getElementById("message").style.textShadow = "2px 2px #3b6338";



        // if they answer all the worst possible answers
      } else if (q1 == "C" && q2 == "A" && q3 == "A" && q4 == "A" && q5 == "B" && q6 == "A" && q7 == "B"){
        ...
        document.getElementById("message").style.backgroundColor = "rgba(181, 78, 33, 0.7)";
        document.getElementById("message").style.textShadow = "2px 2px #7f3819";
        ...
        document.getElementById("message").style.backgroundColor = "rgba(140, 109, 23, 0.7)";
        document.getElementById("message").style.textShadow = "2px 2px #604b0f";
      }
